        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4 sm:space-y-6">
            {competitions.map((comp, i) => (
              <Card 
                key={i} 
                className={`border-0 shadow-lg ${comp.glow} hover:shadow-xl transition-all bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl overflow-hidden group hover:-translate-y-0.5`}
              >
                <div className={`absolute left-0 top-0 bottom-0 w-1 sm:w-1.5 bg-gradient-to-b ${comp.gradient}`} />
                  ...
                  <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-start sm:justify-between gap-2 sm:gap-4 mb-3 sm:mb-4">
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-1 text-xs sm:text-sm text-muted-foreground">
                        ...
                        <Badge variant="outline" className="text-[10px] sm:text-xs border-violet-200 dark:border-violet-800 h-5">{comp.track}</Badge>
                      </div>
                    </div>
                    <Badge className={`bg-gradient-to-r ${comp.gradient} text-white border-0 shadow-md text-xs sm:text-sm self-start`}>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {[
              ...
              <Card key={i} className="border-0 shadow-md bg-white dark:bg-slate-900 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 group">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            <Card className="border-0 shadow-lg bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl">
              <CardContent className="pt-5 sm:pt-6 px-4 sm:px-6 pb-4 sm:pb-6">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center text-white text-lg sm:text-xl shadow-md">
                    💼
                  </div>
            ...
            <Card className="border-0 shadow-lg bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl">
              <CardContent className="pt-5 sm:pt-6 px-4 sm:px-6 pb-4 sm:pb-6">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-fuchsia-500 to-pink-600 flex items-center justify-center text-white text-lg sm:text-xl shadow-md">
                    🌐
                  </div>
