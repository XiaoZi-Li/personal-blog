  ...
  switch (lang) {
    ...
    case 'ja-JP':
      return {
        ...
        practices: [
          { title: 'ReID 人物再識別研究プロジェクト', role: '共第一著者', period: '2024/12 - 2026/02', desc: '論文 CATSANet が SCI ジャーナル Pattern Analysis and Applications に採録、コード公開済み。PyTorch/CLIP による訓練・評価パイプラインを構築、クロスモーダル意味トークン選択モジュールと最適輸送に基づく部位整合損失（PACL）を共同提案、消融実験で検証' },
    ...
    default: // cn
      return {
        ...
        practices: [
          { title: 'ReID 行人重识别科研项目', role: '共同第一作者', period: '2024/12 - 2026/02', desc: '论文 CATSANet 已被 Pattern Analysis and Applications（SCI 期刊）录用，代码已开源。基于 PyTorch/CLIP 构建数据预处理、训练与评估全流程，参与提出跨模态语义 Token 选择模块与基于 Sinkhorn 最优传输的部件对齐损失（PACL），通过消融实验验证其对检索精度的提升' },
