  ...
  switch (lang) {
    case 'en-US':
      return {
        ...
        practices: [
          { title: 'ReID Person Re-identification Research', role: 'Co-first Author', period: '2024/12 - 2026/02', link: 'https://link.springer.com/article/10.1007/s10044-026-01761-5', linkLabel: 'Paper', desc: 'Paper CATSANet officially published in Pattern Analysis and Applications (SCI-indexed journal), code open-sourced. Built full PyTorch/CLIP training & evaluation pipeline; co-proposed cross-modal semantic token selection module and Sinkhorn optimal-transport part alignment loss (PACL), validated by ablation studies' },
    ...
    case 'ja-JP':
      return {
        ...
        practices: [
          { title: 'ReID 人物再識別研究プロジェクト', role: '共第一著者', period: '2024/12 - 2026/02', link: 'https://link.springer.com/article/10.1007/s10044-026-01761-5', linkLabel: '論文', desc: '論文 CATSANet が SCI ジャーナル Pattern Analysis and Applications に正式掲載され SCI 検索可能、コード公開済み。PyTorch/CLIP による訓練・評価パイプラインを構築、クロスモーダル意味トークン選択モジュールと最適輸送に基づく部位整合損失（PACL）を共同提案、消融実験で検証' },
    ...
    default: // cn
      return {
        ...
        practices: [
          { title: 'ReID 行人重识别科研项目', role: '共同第一作者', period: '2024/12 - 2026/02', link: 'https://link.springer.com/article/10.1007/s10044-026-01761-5', linkLabel: '查看论文', desc: '论文 CATSANet 已在 Pattern Analysis and Applications（SCI 期刊）正式发表并被 SCI 检索，代码已开源。基于 PyTorch/CLIP 构建数据预处理、训练与评估全流程，参与提出跨模态语义 Token 选择模块与基于 Sinkhorn 最优传输的部件对齐损失（PACL），通过消融实验验证其对检索精度的提升' },
          ...
          { title: '服务外包创新创业大赛 · 智能家居物联网', role: '嵌入式开发人员', period: '2025/01 - 2025/06', desc: '基于OpenHarmony与鸿蒙Hi3861的智能家居场景控制系统，获中国大学生服务外包创新创业大赛国家级三等奖；负责开发板搭建与软硬件交互，开发传感器采集与低功耗无线通信模块，接入小智AI助手经MCP协议实现语音查询设备信息与下发控制指令' },
        ],
        passions: [
