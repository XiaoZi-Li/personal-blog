...
const translations = {
  'zh-CN': {
    ...
    tutorials: {
      badge: '学习教程',
      title: '学习专区',
      subtitle: '体系化的嵌入式学习教程，和你一起从入门到实战',
      all: '全部',
      tutorialsUnit: '篇教程',
      searchPlaceholder: '搜索教程标题、标签...',
      difficulty: { beginner: '入门', intermediate: '进阶', advanced: '实战' },
      categories: {
        all: '全部教程',
        c51: '51 单片机',
        stm32: 'STM32',
      ...
      categoriesDesc: {
        c51: '单片机入门第一站：寄存器、中断、定时器基础',
        stm32: '从标准库到 HAL，外设驱动与系统设计进阶',
        esp32: 'Wi-Fi / 蓝牙双模物联网开发，连接 AI 生态',
        dcdc: '从拓扑选型到 PCB Layout，电源设计全流程'
      },
      views: '浏览',
      likes: '点赞',
      minRead: '分钟阅读',
      empty: '暂无教程',
      emptyDesc: '教程正在火速编写中，敬请期待',
      loadMore: '加载更多',
      noMore: '已经到底啦',
      backToList: '返回学习专区',
      toc: '目录',
  ...
  'en-US': {
    ...
    tutorials: {
      badge: 'Tutorials',
      title: 'Learning Zone',
      subtitle: 'Structured embedded tutorials — from basics to real projects, together',
      all: 'All',
      tutorialsUnit: 'tutorials',
      searchPlaceholder: 'Search tutorials by title or tag...',
      ...
      categoriesDesc: {
        c51: 'First stop for MCU: registers, interrupts and timers',
        stm32: 'From SPL to HAL: peripherals and system design',
        esp32: 'Wi-Fi / Bluetooth IoT development with AI ecosystem',
        dcdc: 'From topology selection to PCB layout, full power design flow'
      },
      views: 'views',
      likes: 'likes',
      minRead: 'min read',
      empty: 'No tutorials yet',
      emptyDesc: 'New tutorials are on the way — stay tuned',
      loadMore: 'Load More',
      noMore: 'That is all',
      backToList: 'Back to Learning Zone',
      toc: 'Contents',
      related: 'Related',
      likeBtn: 'Like',
      unpublished: 'Draft',
    ...
    blog: {
      badge: 'Blog',
      title: 'Blog Posts',
      subtitle: 'Technical notes and life essays, recording the journey',
      all: 'All',
      article: 'Articles',
      diary: 'Diary',
      articleUnit: 'posts',
      ...
      minRead: 'min read',
      empty: 'No posts yet',
      emptyDesc: 'Inspiration is on the way — stay tuned',
      loadMore: 'Load More',
      noMore: 'That is all',
  ...
  'ja-JP': {
    ...
    tutorials: {
      badge: 'チュートリアル',
      title: '学習ゾーン',
      subtitle: '体系的な組み込み学習チュートリアル、入門から実戦まで一緒に',
      all: 'すべて',
      tutorialsUnit: '本',
      searchPlaceholder: 'タイトルやタグで検索...',
      difficulty: { beginner: '入門', intermediate: '中級', advanced: '実戦' },
      categories: {
        all: 'すべてのチュートリアル',
        c51: '51 マイコン',
        stm32: 'STM32',
      ...
      categoriesDesc: {
        c51: 'マイコン入門第一歩：レジスタ・割り込み・タイマー基礎',
        stm32: 'SPL から HAL へ、ペリフェラルとシステム設計',
        esp32: 'Wi-Fi / Bluetooth IoT 開発、AI エコシステムとの連携',
        dcdc: 'トポロジ選定から PCB レイアウトまで、電源設計の全体流程'
      },
      views: '閲覧',
      likes: 'いいね',
      minRead: '分で読める',
      empty: 'チュートリアルはまだありません',
      emptyDesc: '執筆中です、お楽しみに',
      loadMore: 'もっと見る',
      noMore: 'これで全部です',
      backToList: '学習ゾーンに戻る',
      toc: '目次',
