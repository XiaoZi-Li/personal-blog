...
export const projectDescriptions: Record<string, {
  ...
  'robot-dog': {
    description:
      '基于 RDK X5 + ROS2 的四足机器狗端侧具身智能项目：双目深度估计端侧部署、手势交互与语音链路集成在同一块板子上',
    highlights: [
      'RDK X5（BPU 10 TOPS）端侧部署双目深度估计模型',
      '打通「摄像头取流 → BPU 推理 → 深度图 → 控制指令」实时链路',
      'MediaPipe 手势识别，多帧确认防抖、手势消失即停',
      '定义手势—动作映射与三级运动优先级（紧急避障 > 手势 > 语音）',
      '针对手势误触发设计指令过滤与安全层',
    ],
    status: '已完成',
  },
